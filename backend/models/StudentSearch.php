...
class StudentSearch extends Student
{
    ...
    {
        return [
            [['student_id', 'program_id', 'campus_id'], 'integer'],
            [['student_matrix', 'student_name', 'student_phone', 'student_email'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'student_matrix', $this->student_matrix])
